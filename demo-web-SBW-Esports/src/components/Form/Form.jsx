    ...
    <div className={styles.section}>
      <div className={styles.rule}>
        ...
        <span>
          ...
          <br />
          <h3>วันรับสมัคร</h3>
          ตั้งแต่ วันพุธ วันที่ 15 พฤษภคม 2567 คาบ 9 เวลา 14:55 เป็นต้นไป
          <br />
          <br />
          <h3>ชนิดกีฬาแต่ละประเภท</h3>
          1.ประเภททีมหญิง ROV จำนวน 1 ทีม (ตัวจริง 5 คน สำรองอย่างน้อย 1 คนแต่ไม่เกิน 3 คน <br />
          2.ประเภททีมผสม ชาย 3 หญิง 2 หรือหญิง 3 ชาย 2 ROV จำนวน 1 ทีม (ตัวจริง 5 คน สำรองอย่างน้อย 1 คนแต่ไม่เกิน 3 คน) <br />
          3.ประเภทบุคคลชาย Fifa Online จำนวน 1 คน <br />
          4.ประเภทบุคคลหญิง Fifa Online จำนวน 1 คน <br />
          <br />
          <h3>กติกาการสมัคร</h3>
          ...
          <div className={styles.img}>
            ...
            <img src="https://scontent.fbkk5-8.fna.fbcdn.net/v/t39.30808-6/441970170_297707773392877_3821109210841411289_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=5f2048&_nc_ohc=4BP-uTKs0GUQ7kNvgE7frUK&_nc_ht=scontent.fbkk5-8.fna&oh=00_AYB2WN3iGGuVt8uZiqyS1NIMLMNkH48aCm-Blxslt4q6TQ&oe=666BAC06"></img>
          </div>
        </span>
      </div>
